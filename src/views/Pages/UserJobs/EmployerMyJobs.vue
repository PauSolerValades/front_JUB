    ...
    <span v-for="j in jobs.slice((i - 1) * 2, i * 2)" :key="j.description">
      <card class="mb-5 mr-5 ml-5 mt-5">
        <b-row slot="header" >
          ...
          <b-col>
            <b-row align-h="end">
              <button type="submit" class="btn btn-danger float-right" v-on:click="TODO">Delete</button>
              <button type="submit" class="btn btn-success float-right" v-on:click="TODO">Update</button>
            </b-row>
          </b-col>
        </b-row>
        <b-row>
